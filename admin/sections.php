...
*/
	...
	if(empty($noItems)){
		...
		$sections = dbQuery('sections', DB_ARRAYS, array('fields'=>$fields, 'where'=>"parentId='$parentId' and footerMenu=0", 'start'=>($page-1)*$itemsPerPage - ($page > 1 ? 1 : 0), 'limit'=>$itemsPerPage + ($page > 1 ? 2 : 1), 'order'=>'sortOrder'));
