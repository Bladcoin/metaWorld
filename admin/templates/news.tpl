{include file="header.tpl" activeItem="news" title="{news:title}"}
<div class="page-content-wrap">
  
    {if $messages.saved}<span id="savedMessage" onclick = "{literal}noty({text: '{/literal}{news:messages:0}{literal}', layout: 'topRight', type: 'success'});{/literal}"></span>{/if}
    {if $errors.access_denied}<span id="accessDeniedError" onclick = "{literal}noty({text: '{/literal}{news:errors:0}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.title}<span id="titleError" onclick = "{literal}noty({text: '{/literal}{news:errors:1}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.sectionId}<span id="sectionIdError" onclick = "{literal}noty({text: '{/literal}{news:errors:2}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.not_saved}<span id="notSavedError" onclick = "{literal}noty({text: '{/literal}{news:errors:3}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.no_sections}<span id="noSectionsError" onclick = "{literal}noty({text: '{/literal}{news:errors:4}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.image_not_saved}<span id="imageNotSavedError" onclick = "{literal}noty({text: '{/literal}{news:errors:5}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.article_not_found}<span id="articleNotFoundError" onclick = "{literal}noty({text: '{/literal}{news:errors:6}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.fileName}<span id="fileNameError" onclick = "{literal}noty({text: '{/literal}{news:errors:7}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.fileNameExists}<span id="fileNameExistsError" onclick = "{literal}noty({text: '{/literal}{news:errors:8}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.htaccess}<span id="htaccessError" onclick = "{literal}noty({text: '{/literal}{news:errors:9}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.serializations}<span id="serializationsError" onclick = "{literal}noty({text: '{/literal}{news:errors:10}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.fileNameProhibited}<span id="fileNameProhibitedError" onclick = "{literal}noty({text: '{/literal}{news:errors:11}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.fileNameCharacters}<span id="fileNameCharactersError" onclick = "{literal}noty({text: '{/literal}{news:errors:12}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	<script>
  	{literal}
    ...
    function deleteImageMessage(){noty({text: '{/literal}{news:messages:1}{literal}',layout: 'topRight',type: 'success'})}
    function deleteNewsMessage(){noty({text: '{/literal}{news:messages:2}{literal}',layout: 'topRight',type: 'success'})}
...
{if $action.edit}
	...
	<div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top"> 
            <div class="col-md-3 col-xs-3 nopadding_left"><h2>{news:title}</h2></div>                                                
	...
	<form action="news.php" method="post" id="article" enctype="multipart/form-data">
                ...
                <div class="panel-body tab-content nopadding">
                    <div class="tab-pane active" id="general">
                        <div class="panel panel-default" style="margin-bottom: 0px;">
                            <div class="panel-body"> 
                                <div class="col-md-8"> 
                                    <div class="form-group">{news:general:section}
                                        {if $sections}
                                    ...
                                    <div class="form-group">{news:general:title}                                           
                                    ...
                                    <div class="form-group">{news:general:filename}
                                        <input class="form-control" autocomplete="off" id="fileName" type="text" name="article[fileName]" value="{$article.fileName}" />
                                    </div>
                                    <div class="form-group">{general:alias}<input class="form-control" autocomplete="off" type="text" name="article[alias]" value="{$article.alias}" /></div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-md-12 nopadding">{news:general:primaryImage}                                                                                          
                                            {if $article.images}
                    ...
                    <div class="tab-pane" id="settings">
                        <div class="panel panel-default">
                            <div class="panel-body"> 
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{news:misc:publishDate}</div>  
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{news:general:status}</div>  
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{news:misc:featured}</div>  
                                    <div class="col-md-6 nopadding_right">
                                        <div class="check_box">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{news:misc:comments}</div>  
                                    <div class="col-md-6 nopadding_right">
                                        <div class="check_box">
                    ...
                    <div class="tab-pane" id="seo">
                        <div class="panel panel-default">
                            <div class="panel-body"> 
                                <div class="form-group">{general:metaTitle}<input class="form-control" id="meta_title" type="text" name="article[meta_title]" value="{$article.meta_title}"/></div>
        ...
        <div align="center" class="col-md-12 main main_buttons">
            <input class="btn btn-primary" type="submit" name="action[save]" value="&nbsp; {general:save} &nbsp;" onclick="document.getElementById('article').target='_self'; document.getElementById('article').action='{$GLOBAL_URL}/admin{if $SITE_LANG != ''}/{$SITE_LANG}{/if}/news.php?page={$page}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}'" />	&nbsp;
            <a class="btn btn-primary"  href="news.php?page={$page}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{general:cancel}</a>
        </div>
    </form>
...
{elseif !$errors.access_denied}
	...
	<div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top">                        
            <div class="col-md-6 col-xs-6 nopadding_left"><h2>{news:title}</h2></div>    
            <div class="col-md-6 col-xs-6 nopadding_right">                                                
                <div class="pull-right"> 
                    <a class="btn btn-danger" href="news.php?action[edit]=true" data-toggle="tooltip" data-placement="left" data-original-title="{news:addNews}"><i class="fa fa-plus"></i></a>
					<span>
                        {if $query || $status || $section}
                        <a class="btn btn-danger" href="news.php" ><span class="fa fa-list-alt"></span> {news:showAllNews}</a>
                        {else}
                ...
                <div class=" panel panel-colorful">
                    <div class="panel-body">
                        <div class="search_block_art">
                            <div class="col-md-5 nopadding_left"><input id="quick-search" class="form-control" type="text" name="query" value="{$query}" autocomplete="off" /></div>
							<div class="col-md-3 col-xs-12">{html_options options=$sections selected=$section name=section class="form-control select" onchange="this.form.submit()"}</div>
							<div class="col-md-3 col-xs-12">{html_options options=$statuses selected=$status name=status class="form-control select" onchange="this.form.submit()"}</div>
                        ...
                        <tbody>  
                            ...
                            <tr id="article-{$article.articleId}">
                                ...
                                <td  class="btn-link-action text-center">
                                    <a href="news.php?action[edit]=true&article[articleId]={$article.articleId}&page={$page}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}" class="btn btn-rounded"><span class="fa fa-pen"></span></a>             
