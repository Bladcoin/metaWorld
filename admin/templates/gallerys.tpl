{include file="header.tpl" activeItem="gallerys" title="{gallery:title}"}
<div class="page-content-wrap">
  {if $messages.saved}<span id="savedMessage" onclick = "{literal}noty({text: '{/literal}{gallery:messages:0}{literal}', layout: 'topRight', type: 'success'});{/literal}"></span>{/if}
  {if $errors.access_denied}<span id="accessDeniedError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:0}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.title}<span id="titleError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:1}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.sectionId}<span id="sectionIdError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:2}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.not_saved}<span id="notSavedError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:3}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.no_sections}<span id="noSectionsError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:4}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.image_not_saved}<span id="imageNotSavedError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:5}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.article_not_found}<span id="articleNotFoundError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:6}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.fileName}<span id="fileNameError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:7}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if} 
	{if $errors.fileNameExists}<span id="fileNameExistsError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:8}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.htaccess}<span id="htaccessError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:9}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.serializations}<span id="serializationsError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:10}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.fileNameProhibited}<span id="fileNameProhibitedError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:11}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	{if $errors.fileNameCharacters}<span id="fileNameCharactersError" onclick = "{literal}noty({text: '{/literal}{gallery:errors:12}{literal}', layout: 'topRight', type: 'error'});{/literal}"></span>{/if}
	<script>
  	{literal}
        ...
        function deleteImageMessage(){noty({text: '{/literal}{gallery:messages:1}{literal}',layout: 'topRight',type: 'success'})}
        function deleteGalleryMessage(){noty({text: '{/literal}{gallery:messages:2}{literal}',layout: 'topRight',type: 'success'})}
...
{if $action.edit}
    <div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top"> 
	        <div class="col-md-3 col-xs-3 nopadding_left"><h2>{gallery:title}</h2></div>
	...
	<form action="gallerys.php" method="post" id="article" enctype="multipart/form-data">
    	<input type="hidden" name="article[articleId]" value="{$article.articleId}"/>
        <input type="hidden" name="action[save]" value="1"/>
        <div class="col-md-12"> 
            <div class="panel panel-default tabs">                   
                <ul class="nav nav-tabs nav-justified">
                    <li class="active"><a href="#general" data-toggle="tab" aria-expanded="true">{gallery:tabs:general}</a></li>
                    <li class=""><a href="#gallery" data-toggle="tab" aria-expanded="false">{gallery:tabs:gallery}</a></li>
                    <li class=""><a href="#summary" data-toggle="tab" aria-expanded="false">{gallery:tabs:summary}</a></li>
                    <li class=""><a href="#content" data-toggle="tab" aria-expanded="false">{gallery:tabs:content}</a></li>
                    <li class=""><a href="#misc" data-toggle="tab" aria-expanded="false">{gallery:tabs:misc}</a></li>
                    <li class=""><a href="#seo" data-toggle="tab" aria-expanded="false">{gallery:tabs:seo}</a></li>
                </ul> 
                ...
                <div class="panel-body tab-content nopadding">
                    <div class="tab-pane active" id="general">
                        <div class="panel panel-default">
                            <div class="panel-body">  
                                <div class="col-md-8"> 
                                    <div class="form-group">{gallery:general:section}
                                        {html_options options=$sections name='article[sectionId]' selected=$article.sectionId class="form-control select"}
                                    </div>
                                    <div class="form-group">{gallery:general:title}                                         
                                    ...
                                    <div class="form-group">{gallery:general:filename}
                                        <input class="form-control" autocomplete="off" id="fileName" type="text" name="article[fileName]" value="{$article.fileName}" />
                                    </div>
                                    <div class="form-group">{gallery:general:alias}
                                        <input class="form-control" autocomplete="off" type="text" name="article[alias]" value="{$article.alias}" />
                                    </div>
                                </div>

                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        <div class="col-md-12 nopadding">{gallery:general:primaryImage}
                                            {if $article.images}
                                            <div class="file-previewzo-obzor" id="imageOptions">
                                                <div class="close fileinput-remove text-right" onclick="return deleteGalleryImage({$article.articleId});" data-toggle="tooltip" data-placement="left" data-original-title="Удалить картинку">×</div>
                    ...
                    <div class="tab-pane" id="misc">
                        <div class="panel panel-default">
                            <div class="panel-body"> 
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{gallery:misc:publishDate}</div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{gallery:general:status}</div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{gallery:misc:featured}</div>
                                    <div class="col-md-6 nopadding_right">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{gallery:misc:comments}</div>
                                    <div class="col-md-6 nopadding_right">
                                        <div class="check_box">
                    ...
                    <div class="tab-pane" id="seo">
                        <div class="panel panel-default">
                            <div class="panel-body"> 
                                <div class="form-group">{general:metaTitle}
                                    <input class="form-control" autocomplete="off" id="meta_title" type="text" name="article[meta_title]" value="{$article.meta_title}"/>
                                </div>
                                <div class="form-group">{general:keywords}
                                    <textarea id="keywords" name="article[keywords]" class="form-control" rows="3">{$article.keywords}</textarea>
                                </div>
                                <div class="form-group">{general:description}
                                    <textarea id="description" name="article[description]" class="form-control" rows="3">{$article.description}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12 main main_buttons text-center">
            <input class="btn btn-primary" type="submit" name="action[save]" value="&nbsp; {general:save} &nbsp;" onclick="document.getElementById('article').target='_self'; document.getElementById('article').action='{$GLOBAL_URL}/admin{if $SITE_LANG != ''}/{$SITE_LANG}{/if}/gallerys.php?page={$page}'" />	&nbsp;
            <a class="btn btn-primary" href="gallerys.php?page={$page}">{general:cancel}</a>
        </div>
    </form>
...
{elseif !$errors.access_denied}
    ...
    <div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top">                        
            <div class="col-md-6 col-xs-6 nopadding_left"><h2>{gallery:title}</h2></div>    
            <div class="col-md-6 col-xs-6 nopadding_right">                                                
                <div class="pull-right"> 
                    <a class="btn btn-danger" href="gallerys.php?action[edit]=true" data-toggle="tooltip" data-placement="left" data-original-title="{gallery:addGallery}"><i class="fa fa-plus"></i></a>  
                    <span>
                        {if $query || $status || $section}
                        <a class="btn btn-danger" href="gallerys.php" ><span class="fa fa-list-alt"></span> {articles:showAllArticles}</a>
                        {else}
                        <span class="btn btn-danger" onclick="showSearchForm();" data-toggle="tooltip" data-placement="bottom" data-original-title="{general:search}"><span class="fa fa-search"></span></span>
                        {/if}
                    </span>       
                </div>              
            </div>                           
                    ...
                    <table class="table table-striped table-actions table-hover" id="articles">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="50">{articles:image}</th>
                                <th class="text-center">{general:galleries}</th>
                                <th class="text-center" width="100">{general:section}</th>
                        ...
                        <tbody>
                            ...
                            <tr id="article-{$article.articleId}">
                                ...
                                <td width="100%">
                                    <a href="{if $article.status eq 'visible'}{$article.url}{else}{$SITE_URL}/preview.php?articleId={$article.articleId}{/if}" target="_blank" class="artTitle">
                                        {$article.title|truncate:75}
                                    </a> 
                                </td>
                                <td nowrap="nowrap" title="{$article.section.fullName}">{$article.section.name}</td>
                                <td id="status-{$article.articleId}" align="center">
                                    {$article.statusName nofilter}
                                    {if $adminUser.accessLevel != 'writer' && $article.status eq 'pending'}<br />
                                        <p class="act-deistvie action small" onclick="return approveGallery({$article.articleId});">({articles:approve})</p>
                                    {/if}
                                </td>
                                <td class="btn-link-action text-center">
                                    <a alt="{general:edit}" class="btn btn-rounded" href="gallerys.php?action[edit]=true&article[articleId]={$article.articleId}&page={$page}"><span class="fa fa-pen"></span></a>
                                    <a class="btn btn-danger btn-rounded" onclick="deleteGallery({$article.articleId}, '{$article.title nofilter}');"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
                            {/foreach}
                        </tbody>
                            ...
                            <tr>
                                ...
                                <td align="right" colspan="3">
                                    ...
                                    <ul class="pagination pagination-sm pull-right push-down-10 push-up-10">
                                        ...
                                        {if $number eq $page}
                                        <li class="active"><a href="gallerys.php?page={$number}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{$number}</a></li>
                                        {else}
                                        <li><a href="gallerys.php?page={$number}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{$number}</a></li>
                                        {/if}
                                        {/foreach}
                                    </ul>  
                                    {/if}
...
<script>
    ...
    $('.save_edit_image').click(function(e){	
        ...
        $.post('gallerys.php', {id: id, desc: desc, link: link, action: 'editimage'}, function(data){
            if (data.update == 1){            
