...
{if $action.edit}
	...
	<form action="articles.php" method="post" id="article" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            <div class="panel panel-default tabs">                   
    		    ...
    		    <div class="panel-body tab-content nopadding">
                    ...
                    <div class="tab-pane" id="summary2"> <textarea name="article[summary2]" class="description">{$article.summary2}</textarea></div>
                    <div class="tab-pane" id="content2"> <textarea name="article[content2]" class="description">{$article.content2}</textarea></div>
        ...
        <div class="col-md-12 main main_buttons text-center">
		    <input class="btn btn-primary" type="submit" name="action[save]" value="&nbsp; {general:save} &nbsp;" onclick="document.getElementById('article').target='_self'; document.getElementById('article').action='{$GLOBAL_URL}/admin{if $SITE_LANG != ''}/{$SITE_LANG}{/if}/articles.php?page={$page}'" /> &nbsp; 		
            <a class="btn btn-primary" href="articles.php?page={$page}">{general:cancel}</a>
        </div>
    </form>
                            ...
                            <tr>
                                ...
                                <td align="right" colspan="3">
                                    ...
                                    <ul class="pagination pagination-sm pull-right push-down-10 push-up-10">
                                        ...
                                        {if $number eq $page}
                                        <li class="active"><a href="articles.php?page={$number}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{$number}</a></li>
                                        {elseif $number eq '...'}
                                        ...
                                        {else}
                                        <li><a href="articles.php?page={$number}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{$number}</a></li>
                                        {/if}
                                        {/foreach}
                                    </ul>  
                                    {/if}
