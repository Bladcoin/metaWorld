	                ...
	                <table class="table table-bordered table-striped table-actions">
	                    ...
	                    <tbody>                                            
							<tr class="{cycle values='odd,even'}">
								...
								<td class="data">
									<a href="{$requestUri|urldecode|escape nofilter}" target="_blank">{$requestUri|urldecode|escape nofilter}</a>
								</td>
							</tr>
						</tbody>
	                </table>
	            ...
	            <div class="table-responsive">
	                <table class="table table-bordered table-striped table-actions">
	                    ...
	                    <tbody>                                            
							...
							<tr id="visit-{$visit.visitId}" class="{cycle values='odd,even' advance=false}" onmouseover="this.oldClassName=this.className; this.className='{cycle values='odd,even'}Hov'" onmouseout="this.className=this.oldClassName; this.oldClassName=''">
