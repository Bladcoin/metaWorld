...
<head>        
    ...
    <link href="{$SITE_URL}/admin/favicon/favicon.png" rel="icon" type="image/x-icon"/> 
    <link href="{$SITE_URL}/admin/favicon/favicon.png" rel="shortcut icon">
    <link href="{$SITE_URL}/admin/favicon/apple-touch-icon.png" rel="apple-touch-icon">
    <link href="{$SITE_URL}/admin/favicon/apple-touch-icon-72x72.png" rel="apple-touch-icon" sizes="72x72">
    <link href="{$SITE_URL}/admin/favicon/apple-touch-icon-114x114.png" rel="apple-touch-icon" sizes="114x114">
    <link href="{$SITE_URL}/admin/favicon/icon-192x192.png" rel="icon" sizes="192x192"> 
    ...
    <div class="login-box">
      <form method="post" action="login.php" id="login">
        ...
        <div class="login-body form-horizontal">
          ...
          {if $messages}<p style="color: #fff">{if $messages.logged_out}{login:errors:1}{/if}</p>{/if}
          {if $errors}
            <p class="error">
              {if $errors.enter_username}{login:errors:5}<br>{/if}
              {if $errors.enter_password}{login:errors:6}<br>{/if}
              {if $errors.wrong_username_password}{login:errors:0}{/if}	                		
              {if $errors.enter_username_password}{login:errors:3}{/if}
              {if $errors.captcha}{login:errors:4}{/if}	
            </p>
  				{/if}
          ...
          <div class="form-group" style="margin-bottom: 10px">
              ...
              <div class="input-group">
                ...
                <input type="text" id="adlogin"  name="login[loginName]" value="{$login.loginName}" class="form-control" placeholder="{login:username}" autocomplete="on" style="margin-bottom: 0"/>
              </div>
            </div>
          </div>
          <div class="form-group" style="margin-bottom: 10px">
