{include file="header.tpl" activeItem="rental" title="Прокат авто"}
...
{if $action.edit}
	...
	<div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top"> 
            <div class="col-md-3 col-xs-3 nopadding_left"><h2>Прокат авто</h2></div>                                                
    ...
    <form action="rental.php" method="post" id="article" enctype="multipart/form-data">
        ...
        <div class="col-md-12">  
                                ...
                                <div class="col-md-8">
                                    <div class="{if $conf.product_orderBy eq 1}col-md-6 nopadding_left{else}col-md-12 nopadding{/if}">
                                        <div class="form-group">{products:status}
                                            {html_options options=$statuses|smarty:nodefaults name=article[status] id=status selected=$article.status class="form-control select"}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">{products:general:section}
                                        {if $sections}{html_options options=$sections|smarty:nodefaults name=article[sectionId] id=sectionId selected=$article.sectionId class="form-control select"}{/if}
                                    </div> 
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-6 nopadding">
                                          <div class="check_box"><label><input type="radio" name="article[avail]" value="1"  {if $article.avail} checked{/if} /><i>Б/У</i></label></div>
                                          <div class="check_box"><label><input type="radio" name="article[avail]" value="0"  {if !$article.avail} checked{/if} /><i>Новое</i></label></div>
                                      </div>
                                    </div>
                                    {fetch_articles assign=models skip=$article.articleId fields="title,sectionId" limit=9999 type_content='products'}
                                    {php}
                                      $models = $this->get_template_vars('models');
                                      //$result = array('0'=>'Не указано');
                                      foreach($models as $key => $item){
                                        $result[$item['articleId']] = '[ '.$item['section']['name'].' :: '.$item['title'].' ]';
                                      }
                                      $this->assign('cars',$result);
                                        $article = $this->get_template_vars('article');
                                        $article['connectArray'] = json_decode($article['connect']);
                                    ...
                                    <div class="col-md-4 nopadding_left">
                                      <div class="form-group">                                        
                                          <label class="field_name">Привод</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[privod]" value="{$article.privod}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding">
                                      <div class="form-group">                                        
                                          <label class="field_name">Фары</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[fari]" value="{$article.fari}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding_right">
                                      <div class="form-group">                                        
                                          <label class="field_name">Диски</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[diski]" value="{$article.diski}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding_left">
                                      <div class="form-group">                                        
                                          <label class="field_name">Климат</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[klimat]" value="{$article.klimat}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding">
                                      <div class="form-group">                                        
                                          <label class="field_name">Мультимедийная система</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[multimedia]" value="{$article.multimedia}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding_right">
                                      <div class="form-group">                                        
                                          <label class="field_name">Обивка сидений</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[obivka]" value="{$article.obivka}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding_left">
                                      <div class="form-group">                                        
                                          <label class="field_name">Цвет обивки сидений</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[obivka_color]" value="{$article.obivka_color}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding">
                                      <div class="form-group">                                        
                                          <label class="field_name">Расход топлива</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[rashod]" value="{$article.rashod}" />
                                      </div>
                                    </div>
                                    <div class="col-md-4 nopadding_right">
                                      <div class="form-group">                                        
                                          <label class="field_name">Тип топлива</label>
                                          <input class="form-control" autocomplete="off" type="text" name="article[oil]" value="{$article.oil}" />
                                      </div>
                                    </div>
                                    {* <div id="colors">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><i>{$article.modifiedOn|smarty:nodefaults} ({$article.modifiedBy.loginName|default:"{general:unknowUser}"|smarty:nodefaults})</i></div>
                                </div>
                                {/if}
                                {if $article.addedOn}
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left">{general:created}</div>
                                    <div class="col-md-6 nopadding_right"><i>{$article.addedOn|smarty:nodefaults} ({$article.addedBy.loginName|default:"{general:unknowUser}"|smarty:nodefaults})</i></div>
                                </div>
                                {/if}
                            </div>
                        </div>
      	...
      	<div class="col-md-12 main main_buttons text-center">
      		<input class="btn btn-primary" type="submit" name="action[save]" value="&nbsp; {general:save} &nbsp;" onclick="document.getElementById('article').target='_self'; document.getElementById('article').action='{$GLOBAL_URL}/admin{if $SITE_LANG != ''}/{$SITE_LANG}{/if}/rental.php?page={$page}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}'" />	&nbsp;
      		<a class="btn btn-primary" href="rental.php?page={$page}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{general:cancel}</a>
      	</div>
    </form>
...
{elseif !$errors.access_denied}
    ...
    <div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top">                        
            <div class="col-md-6 col-xs-6 nopadding_left"><h2>Прокат авто</h2></div> 
            <div class="col-md-6 col-xs-6 nopadding_right">        
                <a class="btn btn-danger pull-right" href="rental.php?action[edit]=true" data-toggle="tooltip" data-placement="left" data-original-title="{articles:addArticle}"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
	    	    ...
	    	    <div class=" panel panel-colorful">
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 col-xs-12">
                            ...
                            {html_options options=$sections|smarty:nodefaults selected=$section name=section class="form-control select" onchange="this.form.submit()"}
                        </div>
                        <div class="col-md-4 col-xs-12">
                            ...
                            {html_options options=$statuses|smarty:nodefaults selected=$status name=status class="form-control select" onchange="this.form.submit()"}
                        </div>
                        <div class="clear"></div>
    ...
    <div class="col-md-12">
	    <form action="rental.php{if $page}?page={$page}{/if}" method="post"> 
            <div class="panel panel-default">
                        ...
                        <table class="table table-striped table-actions table-hover" id="articles">
                            ...
                            <tbody> 
                                ...
                                <tr id="article-{$article.articleId}">
                                    ...
                                    <td class="text-center" nowrap="nowrap">{$article.publishedOn|smarty:nodefaults}</td>
                                    ...
                                    <td id="status-{$article.articleId}">
                                        {$article.statusName|smarty:nodefaults}
                                    ...
                                    <td class="btn-link-action text-center">
                                        <a class="btn btn-rounded" href="rental.php?action[edit]=true&article[articleId]={$article.articleId}&page={$page}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}"><span class="fa fa-pen"></span></a>
                                        <a class="btn btn-danger btn-rounded" onclick="deleteProduct({$article.articleId}, '{$article.title|smarty:nodefaults}');"><span class="fa fa-trash"></span></a>
                                    </td>
                                </tr>
                                {/foreach}
                            </tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="right" colspan="4">
                                        ...
                                        <ul class="pagination pagination-sm pull-right push-down-10 push-up-10">
                                          ...
                                          {if $number eq $page}
                                          <li class="active"><a href="rental.php?page={$number}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{$number}</a></li>
                                          {elseif $number eq '...'}
                                          ...
                                          {else}
                                          <li><a href="rental.php?page={$number}{if $query}&query={$query}{/if}{if $section}&section={$section}{/if}{if $status}&status={$status}{/if}">{$number}</a></li>
                                          {/if}
                                          {/foreach}
                                        </ul>  
                                        {/if}
...
<script>
    ...
    $('.save_edit_image').click(function(e){	
        ...
        $.post('rental.php', {id: id, desc: desc, link: link, action: 'editimage'}, function(data){
            if (data.update == 1){            
