            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-actions">
                	...
                	<tr class="{cycle values='odd,even' advance=false}" onmouseover="this.oldClassName=this.className; this.className='{cycle values='odd,even'}Hov'" onmouseout="this.className=this.oldClassName">
                		<td class="data small" width="100%">{$visitor.botName|default:$visitor.userAgent nofilter}</td>
                		<td class="data small action" align="center" onClick="return openWindow('stats.bot.php?visitorId={$visitor.visitorId}{if $filterTypeId}&filterTypeId={$filterTypeId}{/if}', 800, 610)">{$visitor.totalVisits}</td>
                	</tr>
                	{/foreach}
                  	<tr>
