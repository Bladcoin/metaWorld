<?php
/* Smarty version 3.1.34-dev-7, created on 2022-08-15 09:21:54
  from 'C:\xampp\htdocs\themes\dist\templates\article.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_62f9f412b41305_64931400',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4f56041533a8675f67c6642e423e46760f80031e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\themes\\dist\\templates\\article.tpl',
      1 => 1608033716,
      2 => 'file',
    ),
  ),
...
function content_62f9f412b41305_64931400 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\includes\\smarty\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),1=>array('file'=>'C:\\xampp\\htdocs\\includes\\smarty\\plugins\\modifier.replace.php','function'=>'smarty_modifier_replace',),2=>array('file'=>'C:\\xampp\\htdocs\\includes\\smarty\\plugins\\function.fetch_section.php','function'=>'smarty_function_fetch_section',),3=>array('file'=>'C:\\xampp\\htdocs\\includes\\smarty\\plugins\\function.images_articles.php','function'=>'smarty_function_images_articles',),4=>array('file'=>'C:\\xampp\\htdocs\\includes\\smarty\\plugins\\function.fetch_articles.php','function'=>'smarty_function_fetch_articles',),));
$_smarty_tpl->_subTemplateRender("file:header-page.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('title'=>$_smarty_tpl->tpl_vars['article']->value['meta_title'],'keywords'=>$_smarty_tpl->tpl_vars['article']->value['keywords'],'description'=>$_smarty_tpl->tpl_vars['article']->value['description']), 0, false);
?>
<main class="main">
      <!-- Intro block -->
      <div class="intro-block padd">
        <div class="container">
          <div class="intro-block__center bg-img" style="background-image: url(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['images']['original']['url'], ENT_QUOTES, 'UTF-8', true);?>
);">
            <h2 class="intro-block__text"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
</h2>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="page-info__inner">
            <div class="page-info__content">
              <div class="page-info__date"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['article']->value['publishedOn'],'%d.%m.%Y'), ENT_QUOTES, 'UTF-8', true);?>
</div>
              <?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace($_smarty_tpl->tpl_vars['article']->value['content'],'<h3','<h3 class="page-info__title"'),'<ul','<ul class="page-info__list"'),'<li','<li class="page-info__item"');?>
            ...
            <div class="tags">
              <div class="tags__content">
                ...
                <?php echo smarty_function_fetch_section(array('assign'=>'tagsSection','section'=>843),$_smarty_tpl);?>
...
?>
                    <div class="tags__content-item">               
                        <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tagsSection']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
?query=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tag']->value, ENT_QUOTES, 'UTF-8', true);?>
" class="tags__content-link"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tag']->value, ENT_QUOTES, 'UTF-8', true);?>
</a>
                    </div>
                <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
      ...
      <?php echo smarty_function_images_articles(array('getFrom'=>'articles','assign'=>'articleImages','articleId'=>$_smarty_tpl->tpl_vars['article']->value['articleId']),$_smarty_tpl);?>
            ...
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['articleImages']->value, 'item', false, 'key', 'articleImg', array (
));
      ...
      <div class="text__block">
          <div class="container">
              <div class="text__block-content">
                 <?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['article']->value['summary2'],'<h2','<h2 class="page-info__title"');?>
        ...
        <div class="container">
          <div class="info-arcticles__wrapper">
            ...
            <div class="info-arcticles__inner">
                <?php echo smarty_function_fetch_articles(array('assign'=>'sectionArticles','section'=>$_smarty_tpl->tpl_vars['article']->value['section']['sectionId'],'limit'=>3,'skip'=>$_smarty_tpl->tpl_vars['article']->value['articleId']),$_smarty_tpl);?>
