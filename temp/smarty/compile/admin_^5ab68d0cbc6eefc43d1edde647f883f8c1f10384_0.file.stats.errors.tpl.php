<?php
/* Smarty version 3.1.34-dev-7, created on 2022-08-15 12:09:20
  from 'C:\xampp\htdocs\admin\templates\stats.errors.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_62fa1b50e750e8_94253869',
...
function content_62fa1b50e750e8_94253869 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('activeItem'=>"errors",'title'=>"Errors - Statistics"), 0, false);
?>
<div class="content-frame" style="margin-bottom:10px;">
    <div class="content-frame-top">                        
        <div class="page-title"><h2>Errors</h2></div>                           
    </div>
</div>
                ...
                <table class="table table-bordered table-striped table-actions">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Request URI</th>
                            <th class="text-center" width="100">Visits</th>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  	<tr>
	                    ...
	                    <table cellpadding="0" cellspacing="0" width="100%"><tr>
	                 	 	<td class="small">Results <b><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pageNums']->value['startIteration'], ENT_QUOTES, 'UTF-8', true);?>
</b> - <b><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pageNums']->value['endIteration'], ENT_QUOTES, 'UTF-8', true);?>
</b> of <b><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pageNums']->value['totalItems'], ENT_QUOTES, 'UTF-8', true);?>
</b></td>
					 	 	<td align="right">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                   	...
                   	<tr>
	                   	<td colspan="4">
		                   	<table width="100%" cellpadding="5" cellspacing="0">
						   		<tr>
							   		<td class="small">
								   		<span class="code404">404</span> - Page not found, 
								   		<span class="code503">503</span> - Service unavailable, 
								   		<span class="code301">301</span> - Moved permanently
								   	</td>
								</tr>
							</table>
	                   	</td>
                    ...
                    <?php } else { ?>
                   	<tr class="odd">
                  		<td class="data none" colspan="4" align="center">- None -</td>
                   	</tr>
