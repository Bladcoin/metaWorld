<?php
/* Smarty version 3.1.34-dev-7, created on 2022-08-16 11:36:18
  from 'C:\xampp\htdocs\admin\templates\settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_62fb6512a34343_94849574',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b08f3484070f5347057b4bda31bfe8457168e5e1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\admin\\templates\\settings.tpl',
      1 => 1660297079,
      2 => 'file',
    ),
  ),
...
function content_62fb6512a34343_94849574 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('activeItem'=>"settings",'title'=>"Настройки - Управление"), 0, false);
?>
...
>
        ...
        function deleteStatsMessage() {noty({ text: 'Статистические данные удалены.', layout: 'topRight', type: 'success' })}
        function clearCacheMessage() {noty({ text: 'Кэш очищен', layout: 'topRight', type: 'success'})} 
        ...
        <form action="settings.php" method="post" id="settings" autocomplete="off">
            <div class="panel panel-default tabs">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['conf']->value['menu_comments'] == '1') {?><li class=""><a href="#comment" data-toggle="tab" aria-expanded="false">Комментарии</a></li><?php }?>
                        ...
                        <div class="panel panel-default" style="margin-bottom: 0px;">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><input class="form-control" type="text" name="settings[website_name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['website_name'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><input class="form-control" type="text" name="settings[catUrl]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['catUrl'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left"><label class="field_name"><b>Прайс-лист</b></label><p>Прямая ссылка на прайс-лист</p></div>
                                    <div class="col-md-6 nopadding_right"><input class="form-control" type="text" name="settings[catUrl2]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['catUrl2'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                                                <div class="form-group">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> };
                                        <?php echo '</script'; ?>
>
                                        <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['languageOptions']->value,'selected'=>$_smarty_tpl->tpl_vars['config']->value['website_language'],'name'=>'settings[website_language]','onChange'=>"webLanguageOptionChange(this)",'class'=>"form-control select"),$_smarty_tpl);?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['charsetOptions']->value,'name'=>'settings[charset]','selected'=>$_smarty_tpl->tpl_vars['config']->value['charset'],'id'=>'charsetOptions','class'=>"form-control select"),$_smarty_tpl);?>
</div>
                                </div>
                                <div class="form-group">
                                    <!-- Язык интерфейса -->
                                    ...
                                    <div class="col-md-6 nopadding_right"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['adminLangs']->value,'name'=>'settings[admin_language]','selected'=>$_smarty_tpl->tpl_vars['config']->value['admin_language'],'class'=>"form-control select"),$_smarty_tpl);?>
</div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['timeformats']->value,'name'=>'settings[use_24_hours]','selected'=>$_smarty_tpl->tpl_vars['config']->value['use_24_hours'],'class'=>"form-control select"),$_smarty_tpl);?>
</div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['langtimezones']->value,'name'=>"settings[timezone]",'id'=>"timezone",'selected'=>$_smarty_tpl->tpl_vars['config']->value['timezone'],'class'=>"form-control select"),$_smarty_tpl);?>
</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right">
                                        <div class="check_block_box">
                                            <div class="check_box">
                                                <label class="switch switch-small"><input type="checkbox" id="website_down" name="settings[website_down]" value="1" <?php if ($_smarty_tpl->tpl_vars['config']->value['website_down']) {?>checked<?php }?>><span></span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><textarea name="settings[maintenance_message]" class="form-control" rows="5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['maintenance_message'], ENT_QUOTES, 'UTF-8', true);?>
</textarea></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left"><label class="field_name">Список IP адресов</label>
                                        <p>Список IP адресов разрешенных для просмотра сайта, когда сайт выключен.<br> Ваш IP адрес: <b><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ADMINIP']->value, ENT_QUOTES, 'UTF-8', true);?>
</b></p>
                                    </div>
                                    <div class="col-md-6 nopadding_right"><input type="text" id="listIp" class="form-control" name="settings[listIp]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['listIp'], ENT_QUOTES, 'UTF-8', true);?>
" /></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding_right"><input class="form-control" type="text" name="settings[recaptcha_public_key]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['recaptcha_public_key'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left"><label class="field_name">Секретный ключ сервиса reCAPTCHA:v3:</label><p>Получить ключ вы можете по ссылке: <a href="http://www.google.com/recaptcha" target="_blank">http://www.google.com/recaptcha</a><br /> Внимание, настоятельно рекомендуется зарегистрироваться на сервисе и сгенерировать для своего сайта уникальную пару ключей, установив разрешение на использование только на своем домене. Использование стандартной пары ключей, не дает должного эффекта по защите от спам роботов.</p></div>
                                    <div class="col-md-6 nopadding_right"><input class="form-control" type="text" name="settings[recaptcha_private_key]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['recaptcha_private_key'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[company_name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['company_name'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Режим работы</label><p>Укажите режим работы вашей организации</p></div>
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[operating_mode]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['operating_mode'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Адрес</label><p>Укажите юридический адрес вашей компании</p></div>
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[address]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['address'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[feedback_email]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['feedback_email'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Основной телефон</label></div>
                                    <div class="col-md-6 nopadding"><input class="mask_phone form-control" type="text" name="settings[phone]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['phone'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Доп. телефон</label></div>
                                    <div class="col-md-6 nopadding"><input class="mask_phone form-control" type="text" name="settings[phone_two]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['phone_two'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Телефон менеджера</label></div>
                                    <div class="col-md-6 nopadding"><input class="mask_phone form-control" type="text" name="settings[phone_three]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['phone_three'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['mailTransports']->value,'name'=>'settings[mail_transport]','selected'=>$_smarty_tpl->tpl_vars['config']->value['mail_transport'],'class'=>"form-control select"),$_smarty_tpl);?>
</div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" autocomplete="off" name="settings[smtp_subject]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['smtp_subject'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" autocomplete="off" name="settings[email]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['email'], ENT_QUOTES, 'UTF-8', true);?>
" placeholder="noreply@example.com"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" autocomplete="off" name="settings[smtp_server]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['smtp_server'], ENT_QUOTES, 'UTF-8', true);?>
" placeholder="smtp.example.com"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" autocomplete="off" name="settings[smtp_user]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['smtp_user'], ENT_QUOTES, 'UTF-8', true);?>
" placeholder="user@example.com"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" autocomplete="off" type="password" name="settings[smtp_pass]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['smtp_pass'], ENT_QUOTES, 'UTF-8', true);?>
" id="password"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['ports']->value,'name'=>'settings[smtp_port]','id'=>'ports','selected'=>$_smarty_tpl->tpl_vars['config']->value['smtp_port'],'class'=>"form-control select"),$_smarty_tpl);?>
</div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['secures']->value,'name'=>'settings[smtp_secure]','id'=>'secures','selected'=>$_smarty_tpl->tpl_vars['config']->value['smtp_secure'],'class'=>"form-control select"),$_smarty_tpl);?>
</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" autocomplete="off" name="settings[telegram_token]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['telegram_token'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" autocomplete="off" name="settings[telegram_chat_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['telegram_chat_id'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
...
/getUpdates</a></p></div>
                                    ...
                                    <div class="col-md-6 nopadding">
                                        <code style="color: #2554c7;background: none">{"ok":true,"result":[<br>
                                            &nbsp;&nbsp;{<br>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[cont_section]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['cont_section'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding">
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[small_thumb_width]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['small_thumb_width'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                        <div class="col-md-2 nopadding text-center" style="padding-top:5px;"> X </div>
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[small_thumb_height]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['small_thumb_height'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding">
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[medium_thumb_width]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['medium_thumb_width'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                        <div class="col-md-2 nopadding text-center" style="padding-top:5px;"> X </div>
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[medium_thumb_height]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['medium_thumb_height'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding">
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[large_thumb_width]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['large_thumb_width'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                        <div class="col-md-2 nopadding text-center" style="padding-top:5px;"> X </div>
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[large_thumb_height]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['large_thumb_height'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel panel-default" style="margin-bottom: 0px;">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Маленькая картинка (длина X ширина)</label></div>
                                    <div class="col-md-6 nopadding">
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[smallX]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['smallX'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                        <div class="col-md-2 nopadding text-center" style="padding-top:5px;"> X </div>
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[smallY]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['smallY'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Средняя картинка (длина X ширина)</label></div>
                                    <div class="col-md-6 nopadding">
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[mediumX]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['mediumX'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                        <div class="col-md-2 nopadding text-center" style="padding-top:5px;"> X </div>
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[mediumY]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['mediumY'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Большая картинка (длина X ширина)</label></div>
                                    <div class="col-md-6 nopadding">
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[bigX]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['bigX'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                        <div class="col-md-2 nopadding text-center" style="padding-top:5px;"> X </div>
                                        <div class="col-md-5 nopadding"><input type="text" name="settings[bigY]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['bigY'], ENT_QUOTES, 'UTF-8', true);?>
" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><textarea name="settings[comments_hold_words]" class="form-control" rows="6"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['comments_hold_words'], ENT_QUOTES, 'UTF-8', true);?>
</textarea></div>
                                </div>
                                <div class="clear"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"> <textarea name="settings[comments_spam_words]" class="form-control" rows="6"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['comments_spam_words'], ENT_QUOTES, 'UTF-8', true);?>
</textarea></div>
                                </div>
                            </div>
                            <div class="clear"></div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12 nopadding" style="padding-top:20px;">
                                        ...
                                        <div class="col-md-1 col-xs-2 nopadding">
                                            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['cachingTimeOptions']->value,'name'=>"settings[cache_time_sitemap]",'selected'=>$_smarty_tpl->tpl_vars['config']->value['cache_time_sitemap'],'class'=>"form-control select"),$_smarty_tpl);?>

                                        </div>
                                        <div class="col-md-2 col-xs-2 nopadding">
                                            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['cachingPeriodOptions']->value,'name'=>"settings[cache_period_sitemap]",'selected'=>$_smarty_tpl->tpl_vars['config']->value['cache_period_sitemap'],'class'=>"form-control select"),$_smarty_tpl);?>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[yandex_metrika]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['yandex_metrika'], ENT_QUOTES, 'UTF-8', true);?>
"></div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6 nopadding"><label class="field_name">Ваш ID в Google Analytics</label></div>
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[google_analytics]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['google_analytics'], ENT_QUOTES, 'UTF-8', true);?>
"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><textarea name="settings[bot_id_strings]" class="form-control" rows="5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['bot_id_strings'], ENT_QUOTES, 'UTF-8', true);?>
</textarea></div>
                                </div>
                                <!--/ Идентификаторы ботов -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><textarea name="settings[query_fields_strings]" class="form-control" rows="5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['query_fields_strings'], ENT_QUOTES, 'UTF-8', true);?>
</textarea></div>
                                </div>
                                <!--/ Идентификаторы ботов -->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[old_site_url]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['config']->value['site_url'], ENT_QUOTES, 'UTF-8', true);?>
" placeholder="http://domain.uz/"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <div class="col-md-6 nopadding"><input class="form-control" type="text" name="settings[site_url]" value="<?php echo(siteURL())?>" placeholder="http://domain.uz/"></div>
                                </div>
                            </div>
                        </div>
                    </div>
