<?php
/* Smarty version 3.1.34-dev-7, created on 2021-04-21 15:15:41
  from 'C:\xampp\htdocs\admin\templates\news.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6080257d00b047_11359980',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e44a4ec468f4b7d091717bf53a9a62c14e46b406' => 
    array (
      0 => 'C:\\xampp\\htdocs\\admin\\templates\\news.tpl',
      1 => 1603794624,
      2 => 'file',
    ),
  ),
...
function content_6080257d00b047_11359980 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('activeItem'=>"news",'title'=>"Новости"), 0, false);
?>
<div class="page-content-wrap">
  
    <?php if ($_smarty_tpl->tpl_vars['messages']->value['saved']) {?><span id="savedMessage" onclick = "noty({text: 'Новость &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
&raquo; сохранена.', layout: 'topRight', type: 'success'});"></span><?php }?>
	...
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['not_saved']) {?><span id="notSavedError" onclick = "noty({text: 'Новость &laquo;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
&raquo; НЕ сохранена.', layout: 'topRight', type: 'error'});"></span><?php }?>
	...
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['fileNameExists']) {?><span id="fileNameExistsError" onclick = "noty({text: 'Новость с таким именем файла уже существует. Введите другое имя.', layout: 'topRight', type: 'error'});"></span><?php }?>
	...
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['fileNameCharacters']) {?><span id="fileNameCharactersError" onclick = "noty({text: 'Имя файла может состоять только из следующих символов: A-Z a-z 0-9 . , - _', layout: 'topRight', type: 'error'});"></span><?php }?>
	<?php echo '<script'; ?>
>
    ...
    function deleteNewsMessage(){noty({text: 'Новость удалена.',layout: 'topRight',type: 'success'})}
...
<?php if ($_smarty_tpl->tpl_vars['action']->value['edit']) {?>
	...
	<div class="content-frame" style="margin-bottom:10px;">
        <div class="content-frame-top"> 
            <div class="col-md-3 col-xs-3 nopadding_left"><h2>Новости</h2></div>                                                
        ...
        <div class="col-md-12">
            <div class="panel panel-default tabs ">                   
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li class=""><a href="#settings" data-toggle="tab" aria-expanded="false">Разное</a></li>
...
" />
                                    ...
                                    <div class="form-group"><label class="field_name">Альтернативное имя</label><input class="form-control" autocomplete="off" type="text" name="article[alias]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['alias'], ENT_QUOTES, 'UTF-8', true);?>
" /></div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-md-12 nopadding"><label class="field_name">Основная картинка </label>                                                                                           
                                            ...
                                            <div class="file-previewzo-obzor" id="imageOptions">
                                                <div class="close fileinput-remove text-right" onclick="return deleteNewsImage(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['articleId'], ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 - 
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 nopadding_left"><label class="field_name">Cтатус</label></div>  
 ...
 (<?php echo (($tmp = @$_smarty_tpl->tpl_vars['article']->value['addedBy']['loginName'])===null||$tmp==='' ? "Неизвестный пользователь" : $tmp);?>
                    ...
                    <div class="tab-pane" id="seo">
                        <div class="panel panel-default">
                            <div class="panel-body"> 
                                <div class="form-group"><label class="field_name">Заголовок (Meta title)</label><input class="form-control" id="meta_title" type="text" name="article[meta_title]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['meta_title'], ENT_QUOTES, 'UTF-8', true);?>
"/></div>
...
}?>/news.php?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value, ENT_QUOTES, 'UTF-8', true);
...
if ($_smarty_tpl->tpl_vars['status']->value) {?>&status=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'UTF-8', true);
            ...
            <a class="btn btn-primary"  href="news.php?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value, ENT_QUOTES, 'UTF-8', true);
if ($_smarty_tpl->tpl_vars['section']->value) {?>&section=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value, ENT_QUOTES, 'UTF-8', true);
}
if ($_smarty_tpl->tpl_vars['status']->value) {?>&status=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'UTF-8', true);
}?>">Отменить</a>
            ...
            <div class="col-md-6 col-xs-6 nopadding_right">                                                
                <div class="pull-right"> 
					...
					<span>
                        ...
                        <a class="btn btn-danger" href="news.php" ><span class="fa fa-list-alt"></span> Показать все новости</a>
                        <?php } else { ?>
                ...
                <div class=" panel panel-colorful">
                    <div class="panel-body">
                        <div class="search_block_art">
                            <div class="col-md-5 nopadding_left"><input id="quick-search" class="form-control" type="text" name="query" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['query']->value, ENT_QUOTES, 'UTF-8', true);?>
" autocomplete="off" /></div>
							<div class="col-md-3 col-xs-12"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['sections']->value,'selected'=>$_smarty_tpl->tpl_vars['section']->value,'name'=>'section','class'=>"form-control select",'onchange'=>"this.form.submit()"),$_smarty_tpl);?>
</div>
							<div class="col-md-3 col-xs-12"><?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['statuses']->value,'selected'=>$_smarty_tpl->tpl_vars['status']->value,'name'=>'status','class'=>"form-control select",'onchange'=>"this.form.submit()"),$_smarty_tpl);?>
</div>
...
/preview.php?articleId=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['articleId'], ENT_QUOTES, 'UTF-8', true);
                                ...
                                <td nowrap="nowrap" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['section']['fullName'], ENT_QUOTES, 'UTF-8', true);?>
...
" class="data" align="center">
                                    ...
                                    <p class="act-deistvie action small" onclick="return approveNews(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['articleId'], ENT_QUOTES, 'UTF-8', true);?>
);">(Одобрить)</p>
                                    <?php }?>
                                </td>
                                <td  class="btn-link-action text-center">
                                    <a href="news.php?action[edit]=true&article[articleId]=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['articleId'], ENT_QUOTES, 'UTF-8', true);?>
&page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value, ENT_QUOTES, 'UTF-8', true);
if ($_smarty_tpl->tpl_vars['section']->value) {?>&section=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value, ENT_QUOTES, 'UTF-8', true);
}
if ($_smarty_tpl->tpl_vars['status']->value) {?>&status=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'UTF-8', true);
}?>" class="btn btn-rounded"><span class="fa fa-pen"></span></a>             
                                    <a class="btn btn-danger btn-rounded" onclick="deleteNews(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['article']->value['articleId'], ENT_QUOTES, 'UTF-8', true);?>
...
?>
                                      <?php if ($_smarty_tpl->tpl_vars['number']->value == $_smarty_tpl->tpl_vars['page']->value) {?>
                                        <li class="active"><a href="news.php?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['number']->value, ENT_QUOTES, 'UTF-8', true);
...
if ($_smarty_tpl->tpl_vars['status']->value) {?>&status=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value, ENT_QUOTES, 'UTF-8', true);
                                      ...
                                      <?php } elseif ($_smarty_tpl->tpl_vars['number']->value == '...') {?>
                                        ...
                                      <?php } else { ?>
                                        <li><a href="news.php?page=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['number']->value, ENT_QUOTES, 'UTF-8', true);
if ($_smarty_tpl->tpl_vars['query']->value) {?>&query=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['query']->value, ENT_QUOTES, 'UTF-8', true);
}
if ($_smarty_tpl->tpl_vars['section']->value) {?>&section=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value, ENT_QUOTES, 'UTF-8', true);
}
