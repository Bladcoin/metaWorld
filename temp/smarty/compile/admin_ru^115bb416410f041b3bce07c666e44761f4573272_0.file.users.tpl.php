<?php
/* Smarty version 3.1.34-dev-7, created on 2022-08-15 14:25:08
  from 'C:\xampp\htdocs\admin\templates\users.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_62fa3b246732e3_83040652',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '115bb416410f041b3bce07c666e44761f4573272' => 
    array (
      0 => 'C:\\xampp\\htdocs\\admin\\templates\\users.tpl',
      1 => 1603861100,
      2 => 'file',
    ),
  ),
...
function content_62fa3b246732e3_83040652 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\includes\\smarty\\plugins\\function.html_options.php','function'=>'smarty_function_html_options',),1=>array('file'=>'C:\\xampp\\htdocs\\includes\\smarty\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
$_smarty_tpl->_subTemplateRender("file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('activeItem'=>"users",'title'=>"Администраторы - Управление"), 0, false);
?>

  <?php if ($_smarty_tpl->tpl_vars['messages']->value['saved']) {?><span id="savedMessage" onclick = "noty({text: 'Пользователь сохранен.', layout: 'topRight', type: 'success'});"></span><?php }?>
  
  <?php if ($_smarty_tpl->tpl_vars['errors']->value['login_exists']) {?><span id="loginExistsError" onclick = "noty({text: 'Указанное имя пользователя уже существует.', layout: 'topRight', type: 'error'});"></span><?php }?> 
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['user_not_found']) {?><span id="userNotFoundError" onclick = "noty({text: 'Пользователь не найден.', layout: 'topRight', type: 'error'});"></span><?php }?>
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['loginName']) {?><span id="loginNameError" onclick = "noty({text: 'Введите логин. (только цифры и латинские буквы)', layout: 'topRight', type: 'error'});"></span><?php }?>
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['fullName']) {?><span id="fullNameError" onclick = "noty({text: 'Введите имя и фамилию пользователя.', layout: 'topRight', type: 'error'});"></span><?php }?>
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['password']) {?><span id="passwordError" onclick = "noty({text: 'Введите пароль.', layout: 'topRight', type: 'error'});"></span><?php }?> 
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['not_saved']) {?><span id="notSavedError" onclick = "noty({text: 'Пользователь НЕ сохранен: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['errors']->value['not_saved'], ENT_QUOTES, 'UTF-8', true);?>
', layout: 'topRight', type: 'error'});"></span><?php }?> 
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['no_more_admins']) {?><span id="noMoreAdminsError" onclick = "noty({text: 'Невозможно удалить или изменить уровень доступа пользователя, т.к. остался всего один администратор.', layout: 'topRight', type: 'error'});"></span><?php }?>
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['image_not_saved']) {?><span id="imageNotSavedError" onclick = "noty({text: 'Картинка не добавлена', layout: 'topRight', type: 'error'});"></span><?php }?> 
	<?php if ($_smarty_tpl->tpl_vars['errors']->value['developer_status']) {?><span id="developerStatusError" onclick = "noty({text: 'У Вас нет прав получить статус разработчика', layout: 'topRight', type: 'error'});"></span><?php }?>
  <?php if ($_smarty_tpl->tpl_vars['errors']->value['no_more_developers']) {?><span id="noMoreDevelopersError" onclick = "noty({text: 'Невозможно удалить или изменить уровень доступа разработчика, т.к. остался всего один разработчик для техподдержки.', layout: 'topRight', type: 'error'});"></span><?php }?>
...
>
    ...
    $(document).ready(function () {
      ...
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['login_exists']) {?> $('#loginExistsError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['user_not_found']) {?> $('#userNotFoundError').click(); <?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['loginName']) {?> $('#loginNameError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['fullName']) {?> $('#fullNameError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['password']) {?> $('#passwordError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['not_saved']) {?> $('#notSavedError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['no_more_admins']) {?> $('#noMoreAdminsError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['image_not_saved']) {?> $('#imageNotSavedError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['developer_status']) {?> $('#developerStatusError').click();<?php }?>
      <?php if ($_smarty_tpl->tpl_vars['errors']->value['no_more_developers']) {?> $('#noMoreDevelopersError').click();<?php }?>
    ...
    function deleteUserMessage(){noty({text: 'Пользователь удален.',layout: 'topRight',type: 'success'})}
...
<?php if ($_smarty_tpl->tpl_vars['action']->value['edit']) {?>
    ...
    <div class="col-md-3 col-xs-3 nopadding"><div class="page-title"><?php if (!$_smarty_tpl->tpl_vars['user']->value['userId']) {?><h2>Добавить пользователя</h2><?php } else { ?><h2>Профайл пользователя</h2><?php }?></div></div> 	
	...
	<form action="users.php" method="post" enctype="multipart/form-data" id="user">
		<input type="hidden" name="user[userId]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['userId'], ENT_QUOTES, 'UTF-8', true);?>
" />
      ...
      <div class="row">                        
        <div class="col-md-8 col-sm-12 col-xs-12">
          <div class="panel panel-default">
            <?php if (!$_smarty_tpl->tpl_vars['user']->value['userId']) {?>
            ...
            <div class="panel-body">
              <div class="form-group">
                <div class="col-md-3 nopadding_left"><label for="fullName" class="field_name <?php if ($_smarty_tpl->tpl_vars['errors']->value['fullName']) {?>fError<?php }?>">Полное имя</label></div>
                <div class="col-md-9 nopadding_right"><input class="form-control" autocomplete="off" id="fullName" type="text" name="user[fullName]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['fullName'], ENT_QUOTES, 'UTF-8', true);?>
" /></div>
              </div>
              <div class="form-group">
                <div class="col-md-3 nopadding_left"><label for="loginName" class="field_name <?php if ($_smarty_tpl->tpl_vars['errors']->value['loginName']) {?>fError<?php }?>">Логин</label></div>
                <div class="col-md-9 nopadding_right"><input class="form-control" autocomplete="off" id="loginName" type="text" name="user[loginName]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['loginName'], ENT_QUOTES, 'UTF-8', true);?>
" /></div>
              </div>
              <?php if (!$_smarty_tpl->tpl_vars['user']->value['userId']) {?>
              <div class="form-group">
                <div class="col-md-3 nopadding_left"><label for="password" class="field_name <?php if ($_smarty_tpl->tpl_vars['errors']->value['password']) {?>fError<?php }?>">Пароль</label></div>
                <div class="col-md-9 nopadding_right"><input class="form-control" id="password" type="password" name="user[password]"/></div>
              </div>
              <?php } else { ?>
              <div class="form-group">
                <div class="col-md-3 nopadding_left"><label for="password" class="field_name <?php if ($_smarty_tpl->tpl_vars['errors']->value['password']) {?>fError<?php }?>">Новый пароль</label></div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 nopadding_right"><input class="form-control" autocomplete="off" id="email" type="text" name="user[email]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['email'], ENT_QUOTES, 'UTF-8', true);?>
"/></div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-9 nopadding_right"> 
                  <div class="check_box" style="margin-bottom: 5px">
                    <label class="check" id="labelAllow" class="passive">
                      <input class="icheckbox" type="radio" name="user[permitAllSections]" value="1" id="allow" <?php if (!$_smarty_tpl->tpl_vars['user']->value || $_smarty_tpl->tpl_vars['user']->value['permitAllSections']) {?>checked<?php }?> />
                      <i> Разрешить доступ ко всем разделам</i>
                    </label>
                  </div>
                  <div class="check_box">
                    <label class="check" id="labelDisallow" class="passive">
                      <input class="iradio" type="radio" name="user[permitAllSections]" value="0" id="disallow" <?php if ($_smarty_tpl->tpl_vars['user']->value && !$_smarty_tpl->tpl_vars['user']->value['permitAllSections']) {?>checked<?php }?> />
...
"<?php if ($_smarty_tpl->tpl_vars['user']->value['sectionRights'] && in_array($_smarty_tpl->tpl_vars['section']->value['sectionId'],$_smarty_tpl->tpl_vars['user']->value['sectionRights'])) {?>selected=""<?php }?> ><?php if ($_smarty_tpl->tpl_vars['section']->value['level'] > 1) {?>:: <?php } else { ?> <?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['section']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
                      <?php
}
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                <div class="col-md-12 col-xs-12 nopadding">
                  ...
                  <label class="field_name">Фото</label>  
...
"></div>
            ...
            <div class="panel-body form-group-separated">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-6 col-xs-7"><?php if ($_smarty_tpl->tpl_vars['user']->value['status'] == 1) {?> <span style="color: #009688">online</span><?php } else { ?><span style="color: #f10000">offline</span><?php }?></div>
              </div>
            </div>
          </div>
        </div>        
          ...
          <table class="table table-striped table-actions table-hover" id="users">
            <thead>
              <tr>
                ...
                <th><label for="email" class="field_name <?php if ($_smarty_tpl->tpl_vars['errors']->value['email']) {?>fError<?php }?>">Email</label></th>
                <th>Тип</th>
