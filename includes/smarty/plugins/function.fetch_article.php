...
function smarty_function_fetch_article($params, &$smarty){
	global $SECTIONS, $gmNow, $fetchedArticles, $MUSQLILINK;

	$assign        = fetch_getParam('assign', $params, 'article');
	$fields        = fetch_getParam('fields', $params, 'sectionId, publishedOn, title, alias, url, summary, isFeatured, counter,price,discountprice, content2, articul, avail');
